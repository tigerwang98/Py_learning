...
class ChongqingCaizhengSpider(RedisCrawlSpider):
    name = 'Chongqing_caizheng'
    allowed_domains = ['czj.cq.gov.cn']
    # start_urls = ['http://czj.cq.gov.cn/']
    ...
    def parse_jump(self, response):
        url = 'http://czj.cq.gov.cn/' + response.url[1:] + 'index.html'
